...
function StatItem({ label, count, index }: StatItemProps) {
  return (
    <motion.div
      ...
      className="text-center p-4 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 hover:border-primary/30 transition-all duration-300 shadow-sm group hover:shadow-md"
    >
      <div className="flex justify-center mb-3">
        <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-accent text-primary group-hover:scale-110 transition-transform shadow-inner">
