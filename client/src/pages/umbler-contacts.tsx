  ...
  return (
    <div className="bg-gray-50">
      <div className="container mx-auto px-3 py-4 sm:p-6 lg:p-8 space-y-4 sm:space-y-6">
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-4 sm:p-5 hover:bg-gray-50/50 transition-colors">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              ...
              {hasActiveFilters && (
                <Button
                  ...
                  className="h-8 text-xs text-gray-600 hover:bg-gray-100 self-start sm:self-auto"
                >
              ...
              <div className="flex flex-wrap gap-2 pt-1">
                ...
                {selectedTags.length > 0 && (
                  <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded text-xs border border-gray-200 bg-gray-50 text-gray-700">
                    ...
                    {exclusiveTagFilter && (
                      <span className="ml-1 text-[10px] bg-blue-100 text-blue-700 px-1.5 py-0.5 rounded whitespace-nowrap">
                        exclusivo
                      </span>
                    )}
                  </span>
          ...
          <div className="lg:hidden divide-y divide-gray-200">
            {isLoading ? (
              ...
              contacts?.map((contact: any) => (
                <div
                  key={contact.id}
                  className="p-4 hover:bg-gray-50/50 active:bg-gray-100 transition-colors cursor-pointer"
                  onClick={() => handleViewDetails(contact)}
                >
                      ...
                      <div className="flex items-start gap-3 flex-1 min-w-0">
                        ...
                        <div className="flex flex-col min-w-0 flex-1">
                          ...
                          <div className="flex items-center gap-2 mt-2">
                            ...
                            <code className="text-xs bg-gray-100 px-2 py-1 rounded border border-gray-200 font-mono text-gray-700 truncate">
                              {contact.phoneNumber}
                            </code>
                          </div>
                        </div>
