...
// A validação de CPF/CNPJ vive em @shared/document — a mesma regra precisa
// valer no servidor, que também recebe cadastros por outros caminhos.
export { isValidCpf as validateCpf } from "@shared/document";
