...
const navItems: NavItem[] = [
  ...
  { href: "/orcamentos", icon: FileText, label: "Orçamentos", roles: ["admin", "gerente", "vendedor", "eventos"], activeBasePath: "/orcamentos" },
