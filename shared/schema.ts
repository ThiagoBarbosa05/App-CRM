...
// Exporting all tables and schemas
export {
  users,
  insertUserSchema,
  clients,
  ...
  emailCampaignRecipients,
  insertEmailCampaignRecipientSchema,
  userGoals,
  ...
  telemarketingWeeklyResults,
  insertTelemarketingWeeklyResultSchema,
  clientRegistrationGoals,
  insertClientRegistrationGoalSchema,
  clientRegistrationWeeklyResults,
  insertClientRegistrationWeeklyResultSchema,
  birthdayRemindersRelations,
  cashbackSettings,
  insertCashbackSettingSchema,
  cashbackTransactions,
  insertCashbackTransactionSchema,
  clientCashbackBalance,
  insertClientCashbackBalanceSchema,
  cashbackUsage,
  insertCashbackUsageSchema,
  learningImages,
  insertLearningImageSchema,
  clientDebts as clientDebtsTable,
  insertClientDebtSchema,
};